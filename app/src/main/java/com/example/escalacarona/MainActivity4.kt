...
class MainActivity4 : AppCompatActivity() {
    ...
    private lateinit var empList: ArrayList<ViagemModelo>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        empList = arrayListOf<ViagemModelo>()
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    for (empSnap in snapshot.children){
                        val empData = empSnap.getValue(ViagemModelo::class.java)
                        empList.add(empData!!)
                    }
                    val mAdapter = ViagAdapter(empList)
